...
class AdapterWeatherHourly(private val context: Context, private val datas: List<Weather360Response.HourlyForecastBean>) : RecyclerView.Adapter<AdapterWeatherHourly.Holder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AdapterWeatherHourly.Holder {
