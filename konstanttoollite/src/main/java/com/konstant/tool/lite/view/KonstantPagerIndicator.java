...
public class KonstantPagerIndicator extends View implements ViewPager.OnPageChangeListener,
    ...
    public KonstantPagerIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = getContext().obtainStyledAttributes(
                attrs, R.styleable.KonstantPageIndicator, defStyle, 0);

        dotDiameter = a.getDimensionPixelSize(R.styleable.KonstantPageIndicator_dotDiameter,
                DEFAULT_DOT_SIZE * density);
        dotRadius = dotDiameter / 2;
        halfDotRadius = dotRadius / 2;
        gap = a.getDimensionPixelSize(R.styleable.KonstantPageIndicator_dotGap,
                DEFAULT_GAP * density);
        animDuration = (long) a.getInteger(R.styleable.KonstantPageIndicator_animationDuration,
                DEFAULT_ANIM_DURATION);
        animHalfDuration = animDuration / 2;
        unselectedColour = a.getColor(R.styleable.KonstantPageIndicator_pageIndicatorColor,
                DEFAULT_UNSELECTED_COLOUR);
        selectedColour = a.getColor(R.styleable.KonstantPageIndicator_currentPageIndicatorColor,
    ...
    private ValueAnimator createMoveSelectedAnimator(
        ...
        moveSelected.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                ViewCompat.postInvalidateOnAnimation(KonstantPagerIndicator.this);
            }
        });
