package com.yangcong345.kratos.render.view.common.builder;
...
import com.yangcong345.kratos.render.view.common.drawable.ShapeDrawable;
import com.yangcong345.kratos.render.view.common.drawable.ShapeGradientType;
import com.yangcong345.kratos.render.view.common.drawable.ShapeType;
import com.yangcong345.kratos.render.view.common.styleable.IShapeDrawableStyleable;
...
public final class ShapeDrawableBuilder {
    ...
    public ShapeDrawableBuilder setStrokeWidth(float width) {
        mStrokeWidth = width;
        return this;
    }
    ...
    public ShapeDrawableBuilder setShadowOffsetX(float offsetX) {
    ...
    public ShapeDrawableBuilder setShadowOffsetY(float offsetY) {
    ...
    public ShapeDrawable createShapeDrawable(int solidColor, int strokeColor) {
        ...
        drawable.setShape(mShape)
                ...
                .setStroke(strokeColor, mStrokeWidth, mDashWidth, mDashGap);
