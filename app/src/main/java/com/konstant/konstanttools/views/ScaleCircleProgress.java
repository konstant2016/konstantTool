...
public class ScaleCircleProgress extends View {
    ...
    public ScaleCircleProgress(Context context) {
        this(context, null);
    }

    public ScaleCircleProgress(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ScaleCircleProgress(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private int setColorGradient(float percent) {
        ...
        Log.d("颜色", "start-->red:" + redStart + ",green:" + greenStart + ",blue:" + blueStart);
        Log.d("颜色", "end-->red:" + redEnd + ",green:" + greenEnd + ",blue:" + blueEnd);
        Log.d("颜色", "最终-->red:" + red + ",green:" + green + ",blue:" + blue);
