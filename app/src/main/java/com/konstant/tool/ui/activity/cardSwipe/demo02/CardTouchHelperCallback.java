...
public class CardTouchHelperCallback<T> extends ReItemTouchHelper.Callback {
    ...
    @Override
    public void onTouchUp(float dx, float dy,int direction) {
        if (mListener != null){
            mListener.onTouchUp(dx, dy, direction);
        }
    }
    ...
    public void onChildDraw(Canvas c, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder,
        ...
        super.onChildDraw(c, recyclerView, viewHolder, dX, dY, rotationY,actionState, isCurrentlyActive);
