...
public class ReItemTouchHelper extends RecyclerView.ItemDecoration
        ...
        public void onTouchEvent(RecyclerView recyclerView, MotionEvent event) {
            ...
            switch (action) {
                ...
                case MotionEvent.ACTION_CANCEL:
                    mCallback.onTouchUp(mInitialTouchX,mInitialTouchY,swipeIfNecessary(mSelected));
                    if (mVelocityTracker != null) {
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        mCallback.onDraw(c, parent, mSelected,
                mRecoverAnimations, mActionState, dx, dy,0f);
    }
    ...
    public void onTouchUp(MotionEvent event){
        mCallback.onTouchUp(mDx,mDy,swipeIfNecessary(mSelected));
    }
...
//            }
    ...
    public abstract static class Callback {
        ...
        public abstract void onTouchUp(float dx,float dy,int direction);
        ...
        void onDraw(Canvas c, RecyclerView parent, ViewHolder selected,
                    ...
                    int actionState, float dX, float dY,float rotationY) {
            ...
            for (int i = 0; i < recoverAnimSize; i++) {
                ...
                onChildDraw(c, parent, anim.mViewHolder, anim.mX, anim.mY,anim.mRotationY, anim.mActionState,
                        false);
            ...
            if (selected != null) {
                final int count = c.save();
                onChildDraw(c, parent, selected, dX, dY, rotationY,actionState, true);
                c.restoreToCount(count);
            }
        }
        ...
        public void onChildDraw(Canvas c, RecyclerView recyclerView,
            ...
            sUICallback.onDraw(c, recyclerView, viewHolder.itemView, dX, dY, rotationY,actionState,
                    isCurrentlyActive);
        }
